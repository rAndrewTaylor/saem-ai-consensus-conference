# WG Co-Lead Orientation — Wed May 20, 5:00–6:00 PM ET (Zoom)

**Goal:** Every co-lead walks away knowing the panel flow, what to do with their phone/laptop on May 21, and confident they can run their 45-minute panel.

**Attendees:** 11 co-leads + Andrew (chair) + Melissa
**Format:** Zoom, screen-share on platform throughout. Recording shared after for those who can't attend live.

---

## 60-minute run-of-show

### 0:00–0:05 — Welcome + quick logistics (Andrew)
- Day-of timing: arrive 8:30 AM, conference 9 AM–4:30 PM, Atlanta
- Where the in-room MSAs will be sitting (one per WG)
...
### 0:35–0:45 — Audience chat moderation
- Anonymous chat appears in a sidebar on the projector
- Top-upvoted questions float to top
- Co-lead's job: call on highest-upvoted Qs first; rephrase if needed; don't moderate (chair will hide off-topic)
- Co-lead does NOT need to be logged into command center
- If chat is slow, Andrew will prompt a "table-of-three with your neighbors" reset
...
- Wear a name tag with WG number
- Be at the front before your panel slot
- Andrew or Melissa will give the 5-minute warning between panels
- Hand-off: when your panel ends, sit down — chair drives the transition

---

## Pre-orientation tasks for co-leads (send by Mon 5/18)

- [ ] Claim your lead invite at `/lead/claim?token=…` if you haven't
- [ ] Open Lead Dashboard → confirm your WG name and questions look right
- [ ] Skim your WG's R2 report (`/reports/round1` for context, public WG page for R2)
- [ ] Block 5–6 PM ET Wed May 20 on your calendar
- [ ] Bring **one backup starter question** in case audience chat dries up

---

## Co-lead day-of cheat sheet (printed handout)
